...
#############################################################
#
# Interación co usuario para crear directorios e carpetas
#
# autor:
#############################################################
...
# pregunta ó usuario o nome que lle quere dar a un paquete 

# crea dentro do directorio o paquete que conteña os dous ficheiros co nome anterior

# comprime o paquete

# borra os ficheiros e deixa só o paquete no directorio
